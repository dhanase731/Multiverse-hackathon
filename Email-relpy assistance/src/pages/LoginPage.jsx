...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ backgroundColor: '#F8F9FA' }}>
      <main className="flex-grow flex items-center justify-center px-[24px] py-[24px]">
        <div className="w-full max-w-md bg-surface-container-lowest rounded-xl border border-outline-variant shadow-[0px_4px_12px_rgba(0,0,0,0.08)] p-[24px] flex flex-col items-center text-center">
          ...
          <h1 className="font-headline-lg text-headline-lg text-on-surface mb-[8px]">
            Welcome back
          </h1>
          <p className="font-body-md text-body-md text-on-surface-variant max-w-[280px] mb-[24px]">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-[8px] py-3 px-[16px] border border-outline-variant rounded-full font-label-md text-on-surface-variant hover:bg-surface-container transition-all active:scale-95 duration-150 group cursor-pointer bg-white disabled:opacity-50"
          >
          ...
          <div className="mt-[24px] flex flex-col gap-[8px] w-full">
            ...
            <button className="text-primary font-label-md hover:underline transition-all cursor-pointer border-none bg-transparent">
      ...
      <footer className="w-full py-[24px] flex flex-col items-center justify-center gap-[8px] bg-surface-container-lowest border-t border-outline-variant">
